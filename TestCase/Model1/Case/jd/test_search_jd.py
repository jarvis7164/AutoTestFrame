...
from Comm.data import excel_read
from main import TestCasePath


logger = logging.getLogger('main.jd')
# 读取测试数据
file = os.path.join(TestCasePath, 'Model1\\TestData\\jd\\test_jd_desktop.xls')
test_data = excel_read(file)
...
class TestJdSearchDesktop(unittest.TestCase):
    ...
    def test01_JdSearchDesktop(self, test_data):
        """京东搜索测试--电脑"""
