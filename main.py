...
Model1Path = os.path.join(TestCasePath, "Model1")
CasePath = os.path.join(Model1Path, "Case")
jdPath = os.path.join(CasePath, "jd")
...
# 加载测试用例
def get_suite(case_path=jdPath, rule="test*.py"):
    """加载所有的测试用例"""
